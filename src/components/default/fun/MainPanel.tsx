...
import { TechList } from "@/components/default/fun/TechList";
import { Campfire } from "@/components/default/fun/Campfire";
...
export const MainPanel = () => (
  <div className="flex flex-col">
    ...
    <span>
      ...
      take a rest, relax, sip some coffee and sit down next to the campfire. <span className="inline-block animate-sidewaysGlitch">Don&apos;t worry, it won&apos;t bite :)</span>
    </span>
